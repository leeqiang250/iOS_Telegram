...
- (void)testExample {
    ...
    //for (int i = 0; i < 100; i++) {
        _transport = [[MTTcpTransport alloc] initWithDelegate:self context:context datacenterId:1 address:[[MTDatacenterAddress alloc] initWithIp:@"149.154.167.50" port:443 preferForMedia:false]];
