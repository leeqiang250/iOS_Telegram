...
- (instancetype)init
{
    ...
    if (self != nil)
    {
        ...
        TGWebViewController *discoverController = [[TGWebViewController alloc] init];
        //UINavigationController *controller = [[UINavigationController alloc] initWithRootViewController:discoverController];
        ...
        [_mainTabsController setViewControllers:[NSArray arrayWithObjects:_contactsController, _callsController, _dialogListController, discoverController,_accountSettingsController, nil]];
