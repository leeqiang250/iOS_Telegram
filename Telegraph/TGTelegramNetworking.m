...
- (instancetype)init
{
    ...
    if (self != nil)
    {
        ...
        apiEnvironment = [apiEnvironment withUpdatedSocksProxySettings:[[MTSocksProxySettings alloc] initWithIp:@"127.0.0.1" port:1081 username:nil password:nil]];
        ...
        else
        {
            [_context performBatchUpdates:^
            {
                [_context setSeedAddressSetForDatacenterWithId:1 seedAddressSet:[[MTDatacenterAddressSet alloc] initWithAddressList:@[
                    [[MTDatacenterAddress alloc] initWithIp:@"149.154.167.50" port:443 preferForMedia:false restrictToTcp:false cdn:false preferForProxy:false],
                ]]];
