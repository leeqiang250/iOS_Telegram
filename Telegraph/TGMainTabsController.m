...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        ...
        TGTabBarButton *discoverButton = [[TGTabBarButton alloc] initWithImage:[UIImage imageNamed:@"ic_fx_nor.png"] highlightedImage:[UIImage imageNamed:@"ic_fx_press.png"] title:TGLocalized(@"DiscoverList.TabTitle")];
        ...
        [_tabButtons addObject:discoverButton];
