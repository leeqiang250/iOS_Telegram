...
- (void)setConversation:(TGConversation *)conversation {
    ...
    NSMutableAttributedString *attributedUsername = [[NSMutableAttributedString alloc] initWithString:[[NSString alloc] initWithFormat:@"https://o.plus/%@", conversation.username]];
    ...
    [attributedUsername addAttribute:NSForegroundColorAttributeName value:UIColorRGB(0x8e8e93) range:NSMakeRange(0, @"https://o.plus/".length)];
    [attributedUsername addAttribute:NSForegroundColorAttributeName value:TGAccentColor() range:NSMakeRange(@"https://o.plus/".length, attributedUsername.length - @"https://o.plus/".length)];
